...
class Print(object):
    ...
    """
    实现打印功能，调用客户的订单总额，实际支付金额，用户最新信息，打印出来
    """
    ...
    def write_txt(self):
        ...
        c_info = Upgrade().upgrade(total_product_list['memberId'], discount_product_list['discount'])
        ...
        with open("../files/result.txt", 'w') as wf:
            ...
            for discount_product in discount_product_list['discount_product_detail']:
